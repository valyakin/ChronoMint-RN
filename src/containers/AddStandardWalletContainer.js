...
export type AddStandardWalletContainerProps = {
  navigator: any,
}

class AddStandardWalletContainer extends PureComponent<AddStandardWalletContainerProps, {}> {
  ...
  constructor (props: AddStandardWalletContainerProps) {
    super(props)
